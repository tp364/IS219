...
import { EncodeEntryName, Loader, LoaderOptions, Renderers, Spec as VgSpec, TooltipHandler, View, LoggerInterface as Logger } from 'vega';
 ...
 */
export declare function guessMode(spec: VisualizationSpec, logger: Logger, providedMode?: Mode): Mode;
/**
